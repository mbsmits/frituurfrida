...
<body>
	<h1>Saus raden</h1>
	<c:choose>
		<c:when test="${sausRadenSpel.verloren}">         U bent verloren, de saus was ${sausRadenSpel.saus}.       </c:when>
		<c:when test="${sausRadenSpel.gewonnen}">         U bent gewonnen, de saus was ${sausRadenSpel.saus}.       </c:when>
		<c:otherwise>       
